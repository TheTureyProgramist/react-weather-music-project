    ...
    <Overlay $isClosing={isClosing} onClick={handleClose}>
      <Content $isClosing={isClosing} onClick={(e) => e.stopPropagation()}>
        ...
        <Text>
          ...
          активність, вибір аватара, <strong>історію отриманих досягнень та баланс внутрішньої валюти</strong>.
        </Text>
        <Text>
        ...
        <Text>
          4.4.Ми розміщую на сайті головоломки(деякі власні, а інші у власному стилі) + у вікнах зображень головоломок(деяких) компанії 5-bn games(взяв з PlayMarket), з метою мотивації зіграти в їхні ігри.
        </Text>
        <SectionTitle>5. Правила поведінки (Анти-спам)</SectionTitle>
        <Text>
          Забороняється:
          <ul>
            <li>Використання ботів для накрутки прослуховувань треків або штучного отримання досягнень.</li>
            <li>Завантаження зображень, що порушують моральні норми (18+).</li>
            <li>
              Спроби злому системи, маніпуляції з балансом "Конвертів" або несанкціонованого доступу до чужих
              акаунтів.
            </li>
          </ul>
        </Text>
        ...
        <Text>
          ...
          заблокований без попередження. При блокуванні всі досягнення та внутрішня валюта анулюються без права на компенсацію.
        </Text>
        ...
        <SectionTitle>9. Досягнення та Внутрішня валюта (Конверти)</SectionTitle>
        <Text>
          9.1. <strong>Конверти</strong> — це внутрішня віртуальна валюта сервісу, яка не є грошовим засобом у розумінні законодавства та не може бути обміняна на реальні кошти.
        </Text>
        <Text>
        ...
        <Text>
          9.4. Передача Конвертів між акаунтами можлива лише через офіційні інструменти сервісу. Будь-яка "торгівля" валютою поза сервісом заборонена.
        </Text>
        <hr
