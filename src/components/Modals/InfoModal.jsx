    ...
    <Overlay $isClosing={isClosing} onClick={handleClose}>
      <Content $isClosing={isClosing} onClick={(e) => e.stopPropagation()}>
        ...
        <Text $index={12}>
          ...
          аудіовізуального контенту. Адміністрація не є власником розміщених всі
        ...
        <Text $index={14}>
          ...
          пишіть на емеіл theturkeystudio@gmail.com. Примітка: якщо не вийде домовитись, з розміщенням на сайті
        ...
        <Text $index={21}>
          ...
          <ul>
            <li>
              Використання ботів для накрутки прослуховувань треків або штучного інтелекту
              отримання досягнень.
            </li>
            <li>
        ...
        <Text $index={28}>
          ...
          активації функцій, кошти за використаний період.
        </Text>
