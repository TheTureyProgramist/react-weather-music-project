...
const VipModal = ({ onClose }) => {
  ...
  const plusBenefits = {
    ai: [
      {
        src: texts,
        text: "6 безкоштовних повідомлень/день + за 🧧 4 спроби, замість 3 безкоштовних повідомлень/день + за 🧧 2. Після вичерпування ліміту ціна повідомлення 0,11грн, не 0,13грн + 🧧. Ліміт безкоштовних спроб може змінюватися залежно від навантаження на систему.",
      },
    ...
    music: [
      {
        src: monody,
        text: "Музичний файл та текст пісні Monody-TheFatRat та VIP-аватар (Нічний ліс) доступні через 3дн. після реєстрації, не через 7дн.",
      },
      {
        src: asium,
  ...
  const ultraBenefits = {
    ai: [
      {
        src: texts,
        text: "12 безкоштовних повідомлень/день + за 🧧 8 спроби. Далі за 0,1грн 🧧(лише за обширні відповіді)",
      },
    ...
    music: [
      {
        src: monody,
        text: "Музичний файл та текст пісні Monody-TheFatRat та VIP-аватар (Нічний ліс) доступні одразу після реєстрації.",
      },
      {
        src: asium,
    ...
    system: [
      ...
      {
        src: dragons,
        text: "Знижка 50% у магазині конвертів. Сплата тарифу переодоплатою(разово) та місячним тарифом дає 100🧧. Ліміт покупок наборів 🧧*3. Можна зберігати 5000🧧. Шанс 50% на джекпот(Ціна збільшена на 20🧧).",
      },
      {
        src: buton,
        text: "Кнопки Пошук міста/Оновлення, видалення картки має перезарядку 3с.",
      },
