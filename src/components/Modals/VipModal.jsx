...
const VipModal = ({ onClose }) => {
  ...
  const plusBenefits = {
    ...
    music: [
      ...
      {
        src: dinofroz,
        text: "Пісні доступні без інтернету, збоку від кнопки автоповтору(треба час, можна видалити потім). Назавжди!",
      },
      {
        src: horrordog,
    ...
    system: [
      ...
      {
        src: dragons,
        text: "Знижка 25% у магазині 🧧, 🏆 дають додатково до 20🧧, якщо їх к-сть у 🏆 < 40. У сумі вийде 40. Навіть, якщо ви вже виконали 🏆 вони будуть після оплати автоматично відправлені. Сплата тарифу переодоплатою(разово) та місячним тарифом дає 50🧧. Ліміт покупок наборів 🧧*2. Можна зберігати 7500🧧, замість 2500(Після кінця зайві не анулюються, але ви не зможете отримувати наступну партію, доти доки к-сть буде >= ліміту). Шанс 25%(не 20%) на джекпот(Ціна збільшена на 10🧧).",
      },
      {
        src: buton,
  ...
  const ultraBenefits = {
    ai: [
      ...
      {
        src: puzzle2,
        text: "Пам'ять на 42доби! Пам'ять запитів 100. Ліміт паралельних чатів 7.",
      },
    ],
    music: [
      {
    ...
    system: [
      ...
      {
        src: dragons,
        text: "Знижка 50% у магазині 🧧. Сплата тарифу переодоплатою(разово) та місячним тарифом дає 750🧧. Ліміт покупок наборів 🧧*3. Можна зберігати 15000🧧. Шанс 50% на джекпот(Ціна збільшена на 20🧧).",
      },
      {
        src: buton,
      ...
      {
        src: font,
        text: "Станьте творцем, розсміщуйте індивідуальні 3 плейлисти, з лімітом у 12пісень, з обкладиками(в сумі не може бути більше 150мб.). Можете додавати фільтри(на деякий час) та привязати відео з ютубу(до 4хв).",
      }
    ],
  };
      ...
      >
        ...
        <VipBlock>
          ...
          >
            ...
            {tier === "plus" ? (
              <>
                <VipButton>4,99грн/місяць(30дн)</VipButton>
              </>
            ) : (
              <>
                <VipButton>9,99грн/фортнайт(14дн)</VipButton>
              </>
            )}
            <VipText>
        ...
        <VipWarning>
          Примітка: 2.Ціни змінюються, в залежності від скономічного стану. Коли
          підписка закінчиться привілегії(не всі) зникнуть.
        </VipWarning>
        <VipWarning>
