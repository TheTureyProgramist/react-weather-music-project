        ...
        <VipBlock>
          <VipFixScroll>
            ...
            <BenefitCard>
              ...
              <VipBonus>
                Автоповтор на добу дешевший удвічі. А діапазон цін екслюзивних
                аватарів дешевший: 20-30конвертів, замість 20-40.
              </VipBonus>
            </BenefitCard>
            <BenefitCard>
            ...
            <BenefitCard>
              ...
              <VipBonus>
                ...
                місячним тарифом дає 50шт. Ліміт покупок наборів конвертів*2.
                Можна зберігати 1000 конвертів, замість 500.
              </VipBonus>
            </BenefitCard>
            <BenefitCard>
              <BenefitImage src={buton} />
              <VipBonus>
                Кнопки Пошук міста/Оновлення, видалення картки має перезарядку
