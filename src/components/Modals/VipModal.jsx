...
const VipModal = ({ onClose }) => {
  ...
  const plusBenefits = {
    ...
    music: [
      ...
      {
        src: dinofroz,
        text: "Пісні доступні без інтернету, збоку від кнопки автоповтору(треба час для скачування, можна видалити потім). Назавжди!",
      },
      {
        src: letters,
      ...
      {
        src: font,
        text: "Станьте творцем! Розсміщуйте індивідуальні 2 плейлисти(не 1), з лімітом у 2пісні(на ваш альбом), з обкладиками(в сумі не може бути більше 12мб(не 7мб).). Можете прив'язати відео з ютубу(до 3хв). Без монетизації(реклами), якщо ютуб. Назавжди!",
      },
    ],
    system: [
      {
      ...
      {
        src: dragons,
        text: "Знижка 5грн у магазині 🧧, 🏆 дають додатково до 20🧧, якщо їх к-сть у 🏆 < 40. У сумі вийде 40. Навіть, якщо ви вже виконали 🏆 вони будуть після оплати автоматично відправлені. Сплата тарифу переодоплатою(разово) та місячним тарифом дає 50🧧. Ліміт покупок наборів 🧧*2. Можна зберігати 5000🧧, замість 2500(Після кінця зайві не анулюються, але ви не зможете отримувати наступну партію, доти доки к-сть буде >= ліміту). Шанс 25%(не 20%) на джекпот(Ціна збільшена на 10🧧).",
      },
      {
        src: buton,
  ...
  const ultraBenefits = {
    ai: [
      ...
      { src: lebid, text: "3 зображення/міс по 3,99грн, далі 5,99грн. Лімітована акція!" },
    ...
    system: [
      ...
      {
        src: dragons,
        text: "Знижка 15грн у магазині 🧧. Сплата тарифу переодоплатою(разово) та місячним тарифом дає 750🧧. Ліміт покупок наборів 🧧*3. Можна зберігати 10000🧧. Шанс 50% на джекпот(Ціна збільшена на 20🧧).",
      },
      {
        src: buton,
        text: "Кнопки Додавання міста/Видалення картки має перезарядку 3с. Ліміт додаткових карток 8. Лімітована акція!",
      },
      { src: rainbow, text: "Райдужне ім'я та рамка доступні зразу." },
      {
        src: document,
        text: "Досуп до 20 останніх новин. Лімітована акція!",
      },
      {
        src: puzzle3,
      ...
      >
        ...
        <VipBlock>
          ...
          >
            ...
            {tier === "plus" ? (
              <>
                <VipButton>9,99грн/місяць(30дн)</VipButton>
              </>
            ) : (
              <>
                <VipButton>14,99грн/фортнайт(14дн)</VipButton>
              </>
            )}
            <VipText>
        ...
        <RedLine />
        <VipWarning>
          Примітка: 1.Mісячний тариф перемикається автоматично! Деякі функції в
          розробці.
        </VipWarning>
        <VipWarning>
          Примітка: 2.Коли підписка закінчиться привілегії(не всі) зникнуть.
          Бонус лояльності: У тарифі Ultra діє лімітована акція, що активується
          після другої оплати поспіль. Якщо підписка буде перервана на термін
          понад 3 місяці, бонус анулюється, і для його відновлення знадобиться
          повторна серія оплат. Також доступна послуга «Швидкий старт» за 4,99
          грн для миттєвої активації 1 акції.
        </VipWarning>
        <VipWarning>
          Примітка: 3.Переваги Стихії+ оптимізовані в Стихія+ Ultrа, ті що не
          були вказані в Стихія+ Ultra(присутні, але ті самі як в Стихія+.).
        </VipWarning>
      </VipModalDiv>
    </Overlay>
  );
