...
const VipModal = ({ onClose }) => {
  ...
  const plusBenefits = {
    ...
    system: [
      ...
      { src: buton, text: "Кнопки Пошук міста/Оновлення, видалення картки має перезарядку 12с замість 1хв. Прогноз на 17 днів, не на 14 днів." },
  ...
  ai: [
    ...
    system: [
      ...
      { src: buton, text: "Кнопки Пошук міста/Оновлення, видалення картки має перезарядку 3с. Прогноз на 20 днів." },
