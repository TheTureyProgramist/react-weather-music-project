          ...
          <InfoGrid>
            <div>
              ...
              <InfoList>
                ...
                <InfoItem>
                  <span>3 Спец-аватари та кольори імені (випадково). Поліпшіть з <RainbowSpan>Стихія+</RainbowSpan>.</span>
                  <span className="price">20-40 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>Автоповтор всіх пісень(на добу). Поліпшіть з <RainbowSpan>Стихія+</RainbowSpan>.</span>
                  <span className="price">4 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>
                    Запит до ШІ (після 3 безкоштовних спроб, 2 спроби за
                    конверти, далі конверти + гроші). Прискорення перезарядки кнопок(регулюється к-сть) 1 конверт до -12с перезарядки. Поліпшіть з <RainbowSpan>Стихія+</RainbowSpan>.
                  </span>
            ...
            <div>
              ...
              <InfoList>
                ...
                <InfoItem>
                  <span>
                    Джекпот з шансом 20%(можливий на початку добу)<RainbowSpan>Стихія+</RainbowSpan>.
                  </span>
                  <span className="price">+20 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>Досягнення. Поліпшіть з <RainbowSpan>Стихія+</RainbowSpan>.</span>
                  <span className="price">20-40 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>
                    Стартовий набір, усі зібрані аватари, стилі імені та всі пройдені
                    головоломки. Поліпшіть доступність з <RainbowSpan>Стихія+</RainbowSpan>.
                  </span>
