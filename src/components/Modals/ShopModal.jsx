          ...
          <InfoGrid>
            <div>
              ...
              <InfoList>
                ...
                <InfoItem>
                  <span>Спец-аватари (випадково).</span>
                  <span className="price">20-40 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>Автоповтор всіх пісень(на добу).</span>
                  <span className="price">4 🧧</span>
                </InfoItem>
                <InfoItem>
                  <span>
                    Запит до ШІ (після 3 безкоштовних спроб, 2 спроби за
                    конверти, далі конверти + гроші). Прискорення перезарядки кнопок(регулюється к-сть) 1 конверт до -12с перезарядки.
                  </span>
            ...
            <div>
              ...
              <InfoList>
                ...
                <InfoItem>
                  <span>
                    Платний бонус <RainbowSpan>Стихія+</RainbowSpan> щодня.
                  </span>
                ...
                <InfoItem>
                  <span>
                    Стартовий набір, усі зібрані аватари та всі пройдені
                    головоломки.
                  </span>
