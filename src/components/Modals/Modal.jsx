...
const VipModal = ({ onClose }) => {
  ...
  const plusBenefits = {
    ai: [
      {
        src: texts,
        text: "6 безкоштовних повідомлень/день + за 🧧 4 спроби, замість 3 безкоштовних повідомлень/день + за 🧧 2. Після вичерпування ліміту ціна повідомлення 0,1грн, не 0,12грн + 🧧. Ліміт безкоштовних нестабільний через активність користувачів.",
      },
    ...
    music: [
      {
        src: monody,
        text: "Музичний файл та текст пісні Monody-TheFatRat та VIP-аватар (Нічний ліс) доступні одразу після реєстрації, не через 7дн.",
      },
      {
        src: asium,
      ...
      {
        src: horrordog,
        text: "Джойстики звуку та промотувачі 10с вперед/назад для муз. карток.",
      },
      {
        src: letters,
  ...
  const ultraBenefits = {
    ai: [
      {
        src: texts,
        text: "УЛЬТРА ШІ: Безлімітні повідомлення (в межах стабільності системи) та пріоритетна обробка запитів.",
      },
      {
        src: lebid,
        text: "5 безкоштовних зображень щомісяця, фіксована ціна 2.50грн надалі.",
      },
    ],
    music: [
      {
        src: monody,
        text: "Повний доступ до всього преміум-архіву без очікування. Унікальна анімація плеєра.",
      },
      {
        src: asium,
        text: "До 20 пісень в обраному. Можливість створювати власні папки.",
      },
    ],
    system: [
      {
        src: vip,
        text: "Ексклюзивна тема 'Космічний Веселковий Стиль' з унікальними ефектами.",
      },
      {
        src: stars,
        text: "Миттєве оновлення даних та розширений прогноз погоди на 40 днів.",
      },
    ],
  };
    ...
    <Overlay onClick={handleClose}>
      ...
      >
        ...
        <VipWarning>
          ...
                    передоплату знову, якщо не передумаєте до кінця терміну
          тарифу.        {" "}
        </VipWarning>
               {" "}
        <VipWarning>
                    Примітка: 2.Ціни не будуть змінюватись, якщо          
          економічний стан не зміниться. І коли підписка закінчиться
          привілегії(не всі)           зникнуть.        {" "}
        </VipWarning>
             {" "}
      </VipModalDiv>
         {" "}
