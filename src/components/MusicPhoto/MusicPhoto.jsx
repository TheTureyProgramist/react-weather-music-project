...
const musicCards = [
  ...
  },
  {
    ...
    category: "ігри",
    text: "І знову дракони, музика доісторичного світу. Картина взята з мультфільму Динофроз, а музика з гри (My Little Universe-Drаgonora). Звучить при комбінації. Estoty. Ігри.",
    lyrics: "Тут немає тексту.",
    duration: 180,
  },
  {
  ...
  },
  {
    ...
    category: "ігри",
    text: "My little universe. Спокійна і прекрасна музика в японському стилі. Estoty. Гра.",
    lyrics: "Текст відсутній.",
    duration: 160,
  },
  {
    ...
    category: "ігри",
    text: "My little universe. Спокійна і прекрасна музика в механічному стилі. Estoty. Гра.",
    lyrics: "Текст відсутній.",
    duration: 160,
  },
  {
